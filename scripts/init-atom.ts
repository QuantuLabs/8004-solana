...
// Program IDs
const ATOM_PROGRAM_ID = new PublicKey("B8Q2nXG7FT89Uau3n41T2qcDLAWxcaQggGqwFWGCEpr7");
const AGENT_REGISTRY_PROGRAM_ID = new PublicKey("HHCVWcqsziJMmp43u2UAgAfH2cBjUFxVdW1M3C3NqzvT");
