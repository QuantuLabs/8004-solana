// ============================================================================
// ReputationStats v3.11 - Tunable Parameters
// ============================================================================
//
// All algorithm parameters in one place.
// To modify: edit constants → program upgrade → instant effect on all agents.
//
// These values were validated by Hivemind (GPT-5.2 + Gemini 3 Pro) with
// a score of 96/100 for manipulation resistance and statistical soundness.
