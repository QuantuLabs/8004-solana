...
// ============================================================================
// ReputationStats v3.11 - Calculation Functions
// ============================================================================
//
// All calculation logic using parameters from params.rs.
// Modify these functions → program upgrade → instant effect.
//
// CU Budget: ~4500 CU total for update_reputation()
...
fn update_ema(stats: &mut ReputationStats, score: u8, slot_delta: u64) {
...
fn calculate_risk(stats: &ReputationStats, hll_est: u64) -> u8 {
    let mut risk: u32 = 0;
...
fn update_confidence(stats: &mut ReputationStats, hll_est: u64) {
...
fn update_trust_tier(stats: &mut ReputationStats) {
...
///
/// # Arguments
/// * `stats` - Mutable reference to ReputationStats account
...
pub fn update_reputation(
    ...
    if stats.feedback_count == 0 {
        ...
        stats.schema_version = ReputationStats::SCHEMA_VERSION;
    }
...
pub fn maybe_migrate(stats: &mut ReputationStats) {
    match stats.schema_version {
        0 => {
            // Schema version 0 means uninitialized or pre-v3.11
            // No migration needed, initialize will set to 1
            stats.schema_version = ReputationStats::SCHEMA_VERSION;
        }
        1 => {
